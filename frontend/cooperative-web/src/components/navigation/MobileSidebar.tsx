...
import { MobileExperienceModeSwitcher } from "@/components/navigation/MobileExperienceModeSwitcher";
...
export function MobileSidebar({ open, onOpenChange }: MobileSidebarProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="left"
        className="w-80 border-r border-[var(--border)] bg-white p-0"
      >
        <SheetHeader className="border-b border-[var(--border)] px-6 py-5 text-left">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <SheetTitle className="text-lg font-semibold tracking-tight text-[var(--foreground)]">
                Admin Portal
              </SheetTitle>
            </div>
          </div>
